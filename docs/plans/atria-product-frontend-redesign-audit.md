# Frontend Redesign Audit Input

> Frozen kickoff copy for implementation. Durable formal copy: `docs:refactor/atria-product-frontend-redesign.md`.
> This file describes scope, problems, and behavior boundaries only. It is intentionally not a visual design solution.
