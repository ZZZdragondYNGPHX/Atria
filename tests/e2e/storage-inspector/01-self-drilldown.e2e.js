...
test.describe('Storage Inspector · self drill-down', () => {
    test('drills supported paths and blocks leaf-category over-drill', async ({ page }) => {
        ...
        // is the response-level authority: no chevron/click navigation should
        // be exposed, otherwise the UI requests [extensions, <name>] and gets
        // E_INVALID_PATH: extensions category is a leaf.
