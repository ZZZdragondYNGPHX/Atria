...
describe('atria-android-debug-trail', () => {
    beforeEach(() => {
        jest.resetModules();
    ...
    test('initAndroidDebugTrail is a noop when bridge missing', async () => {
        ...
        const mod = await import('../public/scripts/atria-android-debug-trail.js');
    ...
    test('initAndroidDebugTrail with bridge attaches listeners and heap sampler', async () => {
        ...
        globalThis.window = {
            ...
            AtriaAndroid: { pushDebugTrail, setDebugRecordingEnabled: jest.fn() },
        };
    ...
    test('setAndroidDebugRecordingEnabled with bridge forwards boolean', async () => {
        ...
        globalThis.window = {
            ...
            AtriaAndroid: { pushDebugTrail: jest.fn(), setDebugRecordingEnabled },
        };
    ...
    test('pushRenderMarker with bridge calls console.info', async () => {
        ...
        globalThis.window = {
            addEventListener: jest.fn(),
            AtriaAndroid: { pushDebugTrail: jest.fn(), setDebugRecordingEnabled: jest.fn() },
        };
        globalThis.console = { ...console, info: consoleInfo };
