...
describe('MacroLexer', () => {
    ...
    describe('General Macro', () => {
        // {{user}}
        test('should handle macro only', async () => {
            const input = '{{user}}';
            const tokens = await runLexerGetTokens(input);
        ...
        // {{}}
        test('should handle empty macro', async () => {
            const input = '{{}}';
            const tokens = await runLexerGetTokens(input);
        ...
        // {{   user   }}
        test('should handle macro with leading and trailing whitespace inside', async () => {
            const input = '{{   user   }}';
            const tokens = await runLexerGetTokens(input);
        ...
        // {{macro1}}{{macro2}}
        test('should handle multiple sequential macros', async () => {
    ...
    describe('Macro Nesting', () => {
        ...
        test('should handle nested macros', async () => {
        ...
        test('should handle macros with nested quotation marks', async () => {
    ...
    describe('Macro Identifier', () => {
        // {{ a }}
        test('should allow one-character macro identifiers', async () => {
            const input = '{{ a }}';
            const tokens = await runLexerGetTokens(input);
        ...
        // {{my2cents}}
        test('should allow numerics inside the macro identifier', async () => {
        ...
        // {{SCREAM}}
        test('should allow capslock macro', async () => {
            const input = '{{SCREAM}}';
            const tokens = await runLexerGetTokens(input);
        ...
        // {{some-longer-macro}}
        test('should allow dashes in macro identifiers', async () => {
        ...
        // {{legacy_macro}}
        test('should allow underscores as legacy in macro identifiers', async () => {
    ...
    describe('Macro Arguments', () => {
        ...
        test('should tokenize macros with double colons arguments correctly', async () => {
        ...
        test('should handle named arguments with key=value syntax', async () => {
        ...
        test('should handle named arguments with quotation marks', async () => {
        ...
        // {{getvar KEY=big}}
        test('should handle capslock argument name identifiers', async () => {
        ...
        test('should handle argument name identifiers with dashes', async () => {
        ...
        test('should handle legacy argument name identifiers', async () => {
        ...
        test('should handle multiple unnamed arguments in quotation marks', async () => {
        ...
        test('should handle named arguments with mixed style', async () => {
        ...
        // {{doStuff key=}}
        test('should handle macros with empty named arguments', async () => {
        ...
        // {{random "" ""}}
        test('should handle empty unnamed arguments if quoted', async () => {
            const input = '{{random "" ""}}';
            const tokens = await runLexerGetTokens(input);
        ...
        test('should handle macros with special characters in arguments', async () => {
        ...
        test('should handle long macros with multiple arguments', async () => {
        ...
        test('should handle macros with complex argument patterns', async () => {
    ...
    describe('Macro Execution Modifiers', () => {
        // {{!immediate}}
        test('should support ! flag', async () => {
        ...
        // {{#legacy}}
        test('should support legacy # flag', async () => {
            const input = '{{#legacy}}';
            const tokens = await runLexerGetTokens(input);
        ...
        // {{  !  identifier  }}
        test('should allow whitespaces around flags', async () => {
        ...
        // {{ ?~lateragain }}
        test('should support multiple flags', async () => {
        ...
        // {{ ! .importantvariable }}
        test('should support multiple flags with whitespace', async () => {
        ...
        // {{>filtered}}
        test('should support > filter flag as separate token', async () => {
        ...
        // {{ ! > user }}
        test('should support filter flag combined with other flags', async () => {
            const input = '{{ ! > user }}';
            const tokens = await runLexerGetTokens(input);
        ...
        // {{ a shaaark }}
        test('should not capture single letter as flag, but as macro identifiers', async () => {
        ...
        describe('"Error" Cases (Macro Execution Modifiers)', () => {
            // {{ @unknown }}
            test('should not capture unknown special characters as flag', async () => {
                const input = '{{ @unknown }}';
                const { tokens, errors } = await runLexerGetTokensAndErrors(input);
    ...
    describe('Variable Shorthand Syntax', () => {
        // {{.variable}} - Local variable get
        test('should tokenize local variable shorthand', async () => {
            const input = '{{.myvar}}';
            const tokens = await runLexerGetTokens(input);
        ...
        test('should tokenize global variable shorthand', async () => {
            const input = '{{$myvar}}';
            const tokens = await runLexerGetTokens(input);
        ...
        test('should tokenize variable with hyphen in name', async () => {
            const input = '{{.my-var}}';
            const tokens = await runLexerGetTokens(input);
        ...
        test('should tokenize increment operator', async () => {
            const input = '{{.counter++}}';
            const tokens = await runLexerGetTokens(input);
        ...
        test('should tokenize decrement operator', async () => {
            const input = '{{$counter--}}';
            const tokens = await runLexerGetTokens(input);
        ...
        test('should tokenize set operator with value', async () => {
        ...
        test('should tokenize add operator with value', async () => {
            const input = '{{.myvar += 5}}';
            const tokens = await runLexerGetTokens(input);
        ...
        test('should tokenize variable prefix after flags', async () => {
            const input = '{{ !.importantvariable }}';
            const tokens = await runLexerGetTokens(input);
        ...
        test('should tokenize variable with multiple hyphens', async () => {
        ...
        test('should tokenize nested macro in variable value', async () => {
        ...
        test('should tokenize variable shorthand with surrounding whitespace', async () => {
            const input = '{{ .myvar }}';
            const tokens = await runLexerGetTokens(input);
        ...
        test('should tokenize variable with numbers in name', async () => {
        ...
        test('should tokenize variable with underscore in name', async () => {
            const input = '{{.my_var}}';
            const tokens = await runLexerGetTokens(input);
        ...
        test('should tokenize increment operator with surrounding whitespace', async () => {
            const input = '{{.counter ++ }}';
            const tokens = await runLexerGetTokens(input);
    ...
    describe('Macro Output Modifiers', () => {
        ...
        test('should support output modifier without arguments', async () => {
        ...
        test('should support output modifier with named arguments', async () => {
        ...
        test('should support output modifier with unnamed arguments', async () => {
        ...
        test('should support macro arguments before output modifier', async () => {
        ...
        test('should support chaining multiple output modifiers', async () => {
        ...
        test('should support chaining multiple output modifiers with arguments', async () => {
        ...
        // {{macro|outputModifier}}
        test('should support output modifiers without whitespace', async () => {
            const input = '{{macro|outputModifier}}';
            const tokens = await runLexerGetTokens(input);
        ...
        describe('Error Cases (Macro Output Modifiers)', () => {
            // {{|macro}}
            test('should not capture when starting the macro with a pipe', async () => {
                const input = '{{|macro}}';
                const { tokens, errors } = await runLexerGetTokensAndErrors(input);
            ...
            // {{macro || outputModifier}}
            test('[Error] should not allow double pipe used without an identifier', async () => {
                const input = '{{macro || outputModifier}}';
                const { tokens, errors } = await runLexerGetTokensAndErrors(input);
    ...
    // {{unclosed_macro word and more. Done.
        test('should allow unclosed macros, but tries to parse it as a macro', async () => {
    ...
    describe('Macro and Plaintext', () => {
        // Hello, {{user}}!
        test('should handle basic macro tokenization', async () => {
        ...
        // Just some text here.
        test('should tokenize plaintext only', async () => {
    ...
    describe('"Error" Cases in Macro Lexing', () => {
        ...
        test('should treat unopened macros as simple plaintext', async () => {
        ...
        test('should handle valid macro correctly after an invalid macro', async () => {
...
async function runLexerGetTokens(input) {
    const { tokens } = await runLexerGetTokensAndErrors(input);
    return tokens;
}
