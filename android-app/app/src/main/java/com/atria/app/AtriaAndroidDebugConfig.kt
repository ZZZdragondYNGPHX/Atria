 ...
 * toggle. Read on every process onCreate so AtriaLogcatTail can resume
 * without waiting for the frontend to inject the JS bridge.
 */
object AtriaAndroidDebugConfig {
    private const val PREF_NAME = "atria_android_debug_config"
