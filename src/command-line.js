 ...
 * @property {boolean} listen If Atria is listening on all network interfaces
 ...
 * @property {boolean} browserLaunchEnabled If automatically launch Atria in the browser
    ...
    parse(args) {
        const cliArguments = yargs(hideBin(args))
            ...
            .option('browserLaunchEnabled', {
                type: 'boolean',
                default: null,
                describe: 'Automatically launch Atria in the browser',
            })
