...
function getGalleryFolder(char) {
    return Atria.getContext().extensionSettings.gallery.folders[char?.avatar] ?? char?.name;
}
...
function getSortOrder() {
    return Atria.getContext().extensionSettings.gallery.sort ?? defaultSettings.sort;
}
