...
export async function loadGamePackageTextResource(charId, relativePath, options = {}) {
    ...
    if (typeof response.text !== 'function') {
        throw new Error('Game Package resource ' + relativePath + ' did not provide text content');
    }
