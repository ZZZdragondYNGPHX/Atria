...
const FRIENDLY_NAMES = {
    ...
    [SECRET_KEYS.BRAVE_SEARCH]: 'Brave Search',
    ...
    [SECRET_KEYS.OPENAI_RESPONSES]: 'OpenAI Responses',
};
...
const INPUT_MAP = {
    ...
    [SECRET_KEYS.OPENAI_RESPONSES]: '#api_key_responses',
};
