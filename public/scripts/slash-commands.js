...
import { Generate, activateSendButtons, addOneMessage, characters, chat, chatElement, chat_metadata, comment_avatar, deactivateSendButtons, default_avatar, deleteCharacter, deleteSwipe, displayPastChats, duplicateCharacter, eventSource, event_types, extension_prompt_roles, extension_prompt_types, extractMessageBias, generateQuietPrompt, generateRaw, getChatMessageMutationMeta, getCharacters, getCurrentChatDetails, getCurrentChatId, getFirstDisplayedMessageId, getOneCharacter, getRequestHeaders, getThumbnailUrl, is_send_press, main_api, name1, name2, neutralCharacterName, newAssistantChat, online_status, reloadCurrentChat, refreshSwipeButtons, removeMacros, renameCharacter, renameChat, saveChatConditional, saveSettings, saveSettingsDebounced, selectCharacterById, select_selected_character, sendMessageAsUser, sendSystemMessage, setActiveCharacter, setActiveGroup, setCharacterId, setCharacterName, setExtensionPrompt, showMoreMessages, swipe, stopGeneration, substituteParams, system_avatar, system_message_types, this_chid, updateSwipeCounter } from '../script.js';
