...
export function buildAgendaRecentChatText(messages, settings = capabilitySettings[MODULE_NAME]) {
...
export function normalizeAgendaDispatches(state, plannerStep = {}, profile = {}, settings = capabilitySettings[MODULE_NAME]) {
    const dispatches = [];
