 ...
 *   - settings                         MG settings reference (capabilitySettings.memory_graph)
...
const STYLESHEET_HREF = '/scripts/agents/memory/schema-iteration/studio.css';
...
export async function openSchemaIterationStudio(deps) {
    ...
    // (`capabilitySettings.memory_graph[SESSIONS_BUCKET_KEY]`).
        ...
        for (const call of editToolCalls) {
            ...
            try {
                ...
                if (Array.isArray(normalized) && normalized.length > 0) {
                    ...
                    // helpers at
                    // `public/scripts/agents/orchestrator/iter-studio/sandbox-result.js`
