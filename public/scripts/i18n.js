...
// Expose i18n helpers for early-loaded classic scripts and third-party
// extensions that cannot import ESM modules directly. Use a namespaced global
// because `globalThis.translate` is also assigned by the translate extension
// as a different function (signature `translate(text, lang, provider)`);
// since the extension loads later, the bare name would always be the
// extension's, and strings passed by classic scripts would be sent to
// /api/translate/* as language codes.
