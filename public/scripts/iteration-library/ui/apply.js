...
export function renderApplyControls(message, opts = {}) {
    ...
    if (rolledBack) {
        return `<div class="atria_lib_apply_controls atria_lib_apply_rolledback">
    ...
    if (applied) {
        ...
        return `<div class="atria_lib_apply_controls atria_lib_apply_applied">
            <span>${escapeHtml(appliedLine)}</span>
            <button class="menu_button menu_button_small" ${actionAttr}="rollback-batch" data-atria-lib-msg-id="${escapeHtmlAttr(msgId)}">
    ...
    return `<div class="atria_lib_apply_controls atria_lib_apply_pending">
        <button class="menu_button" ${actionAttr}="apply-batch" data-atria-lib-msg-id="${escapeHtmlAttr(msgId)}">
            ${escapeHtml(applyLabel)}
        </button>
        <button class="menu_button menu_button_small" ${actionAttr}="discard-batch" data-atria-lib-msg-id="${escapeHtmlAttr(msgId)}">
